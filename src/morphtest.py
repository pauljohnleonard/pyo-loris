...
loris.exportAiff( os.path.join(path,'clarOK.pytest.aiff'), loris.synthesize( clar, samplerate ), samplerate, 16 )
...
loris.exportAiff( os.path.join(path,'flutOK.pytest.aiff'), loris.synthesize( flut, samplerate ), samplerate, 16 )
...
loris.exportSpc(os.path.join(path,"fluteM.spc"),flut,60)

print 'clarinet times:', clar_times
loris.dilate( clar, clar_times, tgt_times )

loris.exportSpc(os.path.join(path,"clarinetM.spc"),clar,60)
...
loris.exportAiff( os.path.join(path, 'morph.pytest.aiff'),
